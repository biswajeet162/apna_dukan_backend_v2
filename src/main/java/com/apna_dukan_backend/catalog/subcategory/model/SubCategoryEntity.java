package com.apna_dukan_backend.catalog.subcategory.model;
...
public class SubCategoryEntity {
    @Id
    @Column(name = "sub_category_id", columnDefinition = "UUID")
    ...
    public SubCategoryEntity(UUID subCategoryId, UUID categoryId, String name, String description,
