package com.apna_dukan_backend.catalog.productgroup.model.domain;
...
public class ProductGroup {
    ...
    public ProductGroup(UUID productGroupId, UUID subCategoryId, String name, String description,
